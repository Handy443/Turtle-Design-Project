...
#function file
#My custom function is at the bottom - Manuel Quinones

def polygon(t,s,d,c):
    angle = 360/s#angle variable is inside the function
    t.begin_fill()
...
def quadround(t,d1,d2,c):#Custom function by Manuel Quinones
    t.color(c)
    t.forward(d1)
